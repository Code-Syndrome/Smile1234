    ...
    <tbody><tr>
      <td height="15" colspan="5" valign="middle" class="main-tit"></td>
        ...
        <asp:Repeater ID="Repeater1" runat="server">
            <ItemTemplate>
                 <tr>
      <td  width="45%" class="tdbg proimg " valign="middle"><img src="<%#Eval("tupian") %>" width="74" height="74" ><%# Eval("shangpinname")%></td>

      <td  width="15%" align="center" class="tdbg">￥<%# Eval("price")%><br></td>
 ...
 <table width="100%" border="0" cellpadding="0" cellspacing="0" class="main_top tab">
    <tbody><tr>
      <td valign="middle" class="hyts" align="center" style="width: 762px">总数量：<span class="jiage red" style="color:Red">
          <asp:Literal ID="Literal2" runat="server"></asp:Literal> &nbsp;&nbsp;&nbsp; </span>总金额：￥<span class="jiage red" style="color:Red">
    ...
    <table>
                 ...
                 <td align="center">
                        ...
                        <asp:RadioButton ID="RadioButton6" runat="server" GroupName="zf" ToolTip="支付宝" />
                                                    ...
                                                    </table></div><div id="ctl00_ContentPlaceHolder1_txt_otimeTip" style="width:250px;display:inline;float:left;text-align:left;"></div>
 </td></tr>
