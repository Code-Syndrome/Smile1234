<%@ Page Title="" Language="C#" MasterPageFile="~/idx.master" AutoEventWireup="true" CodeFile="hlView.aspx.cs" Inherits="news" %>
                ...
                <div class="box_1">
                    <div style="border: 4px solid #fcf8f7; background-color: #fff; padding: 20px 15px;">
                        <div class="tc" style="padding: 8px;">
                            <font class="f5 f6">
                                <asp:Label ID="lbtitle" runat="server" Text=""></asp:Label></font><br>
                            <font class="f3">发布时间：<asp:Label ID="lbaddtime" runat="server" Text=""></asp:Label></font>
                        </div>
