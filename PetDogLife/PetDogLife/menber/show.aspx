...
<div class="box" >
 ...
 <tr>
	...
	<td height="25" width="*" align="left" style="text-align:left"><asp:Label ID="lblsprice" runat="server" Text=""></asp:Label></td>
	</tr>
 ...
 <tr>
	...
	<td height="25" width="*" align="left" style="text-align:left"><asp:Label ID="Label1" runat="server" Text=""></asp:Label></td>
	</tr>

           <tr>
	<td height="25" width="20%" align="right">物流信息：</td>
	<td height="25" width="*" align="left" style="text-align:left"><asp:Label ID="Label2" runat="server" Text=""></asp:Label></td>
	</tr>
...
<tr>	<td height="25" width="20%" align="right"></td>
  <td align="left">
