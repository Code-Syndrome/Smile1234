  ...
  <span>新闻资讯详情</span>
    ...
    <div class="box_1">
      <div style="border:4px solid #fcf8f7; background-color:#fff; padding:20px 15px;">
         ...
         <font class="f5 f6"><asp:Label ID="lbltitle" runat="server" Text=""></asp:Label></font><br><font class="f3">发布时间：<asp:Label ID="lbladdtime" runat="server" Text=""></asp:Label></font>
         </div>
