<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="Modify.aspx.cs" Inherits="dog_Edit" %>
                        ...
                        <td align="center">
                            ...
                            <table style="width: 100%;" id="ctl00_ContentPlaceHolder1_GridView1">
                                ...
                                <tr>
                                    ...
                                    <td class="tbright">
                                        <div style="display: inline; float: left;">
                                            <asp:Image ID="Imagephoto" runat="server" Width="60px" Height="60px" /><asp:Label ID="Labelphoto" Visible="false" runat="server"></asp:Label><asp:FileUpload ID="fpphoto" runat="server" Width="250" />
                                        支持格式为：.jpg | .gif | .png
                                    </td>
                                </tr>
