<%@ Page Title="" Language="C#" MasterPageFile="~/admin/MasterPage.master" AutoEventWireup="true" ValidateRequest="false" CodeFile="Manage.aspx.cs" Inherits="members_List" %>
                            ...
                            <table style="width: 100%;">
                                <tr>
                                    <td align="center">
                                        ...
                                        <strong>姓名:</strong><asp:TextBox ID="txt_mname" runat="server" Width="150"></asp:TextBox>
                                    ...
                                    <td>
                                        <asp:GridView ID="GridView1" runat="server" AutoGenerateColumns="False" Width="100%" GridLines="None" AllowPaging="True" OnPageIndexChanging="GridView1_PageIndexChanging">
                                            ...
                                            <Columns>
                                                ...
                                                <asp:BoundField HeaderText="姓名" DataField="mname" />
                                                ...
                                                <asp:TemplateField HeaderText="操作">
                                                    <ItemTemplate>
                                                        <a href="View.aspx?id=<%#Eval("lname") %>">详情</a>
                                                        <a href="Modify.aspx?id=<%#Eval("lname") %>">修改</a>
